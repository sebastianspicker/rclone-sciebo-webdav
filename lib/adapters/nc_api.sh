...
#
# Built on lib/adapters/http.sh: every helper either fills HTTP_BODY / prints a value or
...
# The DAV/OCS helpers are built on lib/adapters/http.sh, always loaded before this
# file.
