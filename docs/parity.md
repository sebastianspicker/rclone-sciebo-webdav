...
How far `sciebo` matches the [Nextcloud Desktop
client](https://docs.nextcloud.com/desktop/latest/user_manual/index.html),
feature by feature. "Parity" means the same job can be done from the CLI with
the same safety properties; it does not mean a GUI.
